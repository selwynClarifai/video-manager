...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2futils_2fdatabatch_2eproto = {
  false, false, descriptor_table_protodef_proto_2futils_2fdatabatch_2eproto, "proto/utils/databatch.proto", 223,
...
static bool dynamic_init_dummy_proto_2futils_2fdatabatch_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2futils_2fdatabatch_2eproto)), true);
...
DataBatch::DataBatch(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena),
  example_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:DataBatch)
}
...
void DataBatch::ArenaDtor(void* object) {
  DataBatch* _this = reinterpret_cast< DataBatch* >(object);
  (void)_this;
}
void DataBatch::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
template<> PROTOBUF_NOINLINE ::DataBatch* Arena::CreateMaybeMessage< ::DataBatch >(Arena* arena) {
  return Arena::CreateMessageInternal< ::DataBatch >(arena);
}
