...
const char descriptor_table_protodef_proto_2fclarifai_2fapi_2fstatus_2fstatus_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "larifai.api.statusP\001Z\006status\242\002\004CAIPb\006pro"
  "to3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fclarifai_2fapi_2fstatus_2fstatus_2eproto = {
  false, false, descriptor_table_protodef_proto_2fclarifai_2fapi_2fstatus_2fstatus_2eproto, "proto/clarifai/api/status/status.proto", 483,
...
static bool dynamic_init_dummy_proto_2fclarifai_2fapi_2fstatus_2fstatus_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2fclarifai_2fapi_2fstatus_2fstatus_2eproto)), true);
namespace clarifai {
namespace api {
namespace status {
...
Status::Status(const Status& from)
  ...
  if (!from._internal_req_id().empty()) {
    req_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_req_id(),
      GetArena());
  }
  ...
  if (!from._internal_internal_details().empty()) {
    internal_details_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_internal_details(),
      GetArena());
  }
...
void Status::InternalSwap(Status* other) {
  ...
  req_id_.Swap(&other->req_id_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  internal_details_.Swap(&other->internal_details_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
