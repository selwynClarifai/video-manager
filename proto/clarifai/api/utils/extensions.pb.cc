...
const char descriptor_table_protodef_proto_2fclarifai_2fapi_2futils_2fextensions_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "rifai.api.utilsP\001Z\005utils\242\002\004CAIPb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fclarifai_2fapi_2futils_2fextensions_2eproto = {
  false, false, descriptor_table_protodef_proto_2fclarifai_2fapi_2futils_2fextensions_2eproto, "proto/clarifai/api/utils/extensions.proto", 319,
...
static bool dynamic_init_dummy_proto_2fclarifai_2fapi_2futils_2fextensions_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2fclarifai_2fapi_2futils_2fextensions_2eproto)), true);
namespace clarifai {
namespace api {
namespace utils {
